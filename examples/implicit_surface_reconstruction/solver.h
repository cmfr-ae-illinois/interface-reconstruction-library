...
//   implicitSurfaceMetrics(const BasicMesh& mesh_) : mesh(mesh_) {}

//   // volume moments
//   Data<IRL::VolumeMoments> volume_moments;
//   Data<IRL::GeneralMoments3D<2>> moments;
//   // surface moments
//   Data<IRL::GeneralSurfaceMoments3D<2>> surface_moments;
// };
...
//         //                            IRL::VolumeMoments>
//         //     cutter(sphere, cell);
//         IRL::ImplicitSurfaceCutter<IRL::Orthocircle<double,
//         max_refine_level>,
//                                    IRL::VolumeMoments>
...
//   getReconstruction(method_1, liq_moments, gas_moments, 0.0, velU, velV,
//   velW,
//                     &interface);
//   getReconstruction(method_2, liq_moments, gas_moments, 0.0, velU, velV,
//   velW,
//                     &interface_2);

//   writeInterfaceToFile(liq_moments, interface, simulation_time, &vtk_io,
//   true); writeInterfaceToFile(liq_moments, interface_2, simulation_time,
//   &vtk_io2,
//                        true);
// }
