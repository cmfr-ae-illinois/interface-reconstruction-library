...
#ifndef EXAMPLES_IMPLICIT_SURFACE_RECONSTRUCTION_BASIC_MESH_H_
#define EXAMPLES_IMPLICIT_SURFACE_RECONSTRUCTION_BASIC_MESH_H_
...
#endif  // EXAMPLES_IMPLICIT_SURFACE_RECONSTRUCTION_BASIC_MESH_H_
