...
class Spline {
    ...
    public: 
        ...
        static std::vector<double> pack(std::vector<std::vector<double>> Q,std::vector<std::vector<double>> T);
        // Unpacking from Optimization to Interpolation
        static std::vector<std::vector<std::vector<double>>> unpack(std::vector<double> V);
        ...
        std::vector<std::vector<double>> clippedBezier(double u1, double u2);
        ...
        std::vector<double> getTangent(double u);
