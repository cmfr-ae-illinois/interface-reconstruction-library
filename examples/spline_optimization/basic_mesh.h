...
#ifndef EXAMPLES_PARABOLOID_SPLINE_BASIC_MESH_H_
#define EXAMPLES_PARABOLOID_SPLINE_BASIC_MESH_H_
...
class BasicMesh {
 public:
  ...
  BasicMesh(const int a_nx, const int a_ny, const int a_ngc)
      : dx_m(0.0),
        dy_m(0.0),
        nx_m(a_nx),
        ny_m(a_ny),
  ...
  void setCellBoundaries(const IRL2D::Vec& a_bottom_bounding_box,
  ...
  double cell_volume(void) const { return dx_m * dy_m; }
  ...
  void getIndices(const IRL2D::Vec& a_location, int* a_indices) const;
...
#endif  // EXAMPLES_PARABOLOID_SPLINE_BASIC_MESH_H_
