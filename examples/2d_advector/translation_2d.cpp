...
BasicMesh Translation2D::setMesh(const int a_nx) {
...
void Translation2D::initialize(Data<double>* a_U, Data<double>* a_V,
                            Data<IRL2D::Parabola>* a_interface,
                            const double a_time) {
  Translation2D::setVelocity(a_time, a_U, a_V);
...
void Translation2D::setVelocity(const double a_time, Data<double>* a_U,
                             Data<double>* a_V) {
  const BasicMesh& mesh = a_U->getMesh();
...
const IRL2D::Vec Translation2D::getExactVelocity2D(double t, const IRL2D::Vec& P) {
  // const double vel_scale = 2.0 * M_PI;
