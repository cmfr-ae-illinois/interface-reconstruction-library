...
#ifndef EXAMPLES_SIMPLE_SURFACE_ADVECTOR_VTK_H_
#define EXAMPLES_SIMPLE_SURFACE_ADVECTOR_VTK_H_
...
class VTKOutput {
 ...
 public:
  ...
  void writeVTKInterface(
      ...
      std::vector<double>& a_polygon_data,
      std::vector<double>& a_paraboloid_data,
      std::vector<double>& a_cylinder_data, const bool a_print_info = false);
...
#endif  // EXAMPLES_SIMPLE_SURFACE_ADVECTOR_VTK_H_
