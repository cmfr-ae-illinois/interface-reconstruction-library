...
// Vec Mapping(const BezierList& triangle1, const BezierList& triangle2, const Vec& point1){
//   auto A = Mat();
//   auto b = Vec();
//   auto point2 = Vec();
...
//   // mapped point
//   point2.x() = A[0][0]*point1.x() + A[0][1]*point1.y() + b[0];
//   point2.y() = A[1][0]*point1.x() + A[1][1]*point1.y() + b[1];
...
// std::vector<Moments> InitializeTriangleMoments(const int& num_triangles){
//   return std::vector<Moments>(num_triangles, Moments());
// }
