...
module f_PUNeigh_RectCub_class
    ...
    interface setCenterOfStencil
        module procedure PUNeigh_RectCub_class_setCenterOfStencil
    end interface
  ...
  interface
    ...
    subroutine F_PUNeigh_RectCub_setCenterOfStencil(this, a_index) &
      bind(C, name="c_PUNeigh_RectCub_setCenterOfStencil")
      import
      implicit none
      type(c_PUNeigh_RectCub) :: this
      integer(C_INT) :: a_index
    end subroutine F_PUNeigh_RectCub_setCenterOfStencil
  ...
  contains
    ...
    subroutine PUNeigh_RectCub_class_setCenterOfStencil(this, a_index)
      implicit none
      type(PUNeigh_RectCub_type), intent(in) :: this
      integer(IRL_UnsignedIndex_t), intent(in) :: a_index
      call F_PUNeigh_RectCub_setCenterOfStencil(this%c_object, a_index)
    end subroutine PUNeigh_RectCub_class_setCenterOfStencil
