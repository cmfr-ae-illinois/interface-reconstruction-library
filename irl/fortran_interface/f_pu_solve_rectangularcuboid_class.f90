...
module f_PUSolve_RectCub_class
    ...
    interface solveEdge
        module procedure PU_RectCub_class_solveEdge
    end interface
    ...
    interface getValue
        module procedure PU_RectCub_class_getValue
    end interface
    interface getTangent
        module procedure PU_RectCub_class_getTangent
    end interface
    interface getWeight
        module procedure PU_RectCub_class_getWeight
    end interface
