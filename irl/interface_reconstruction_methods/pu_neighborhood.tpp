...
namespace IRL {
    ...
    // template <class CellType>
    // const SeparatorType& PUSTNeighborhood<CellType>::getCenterCellStoredMoments(void) const {
    //     this->checkCenterStencilSet();
    ...
    // template <class CellType>
    // const SeparatorVariant& PUSTNeighborhood<CellType>::getStoredMoments(const UnsignedIndex_t a_index) const {
    //     this->checkIndex(a_index);
    //     return collection_m.getStoredMoments(a_index);
    // }

    template <class CellType>
    const SeparatorVariant& PUSTNeighborhood<CellType>::getSeparator(const UnsignedIndex_t a_index) const {
        this->checkIndex(a_index);
        return separators_m[a_index];
    }

    template <class CellType>
    const Pt& PUSTNeighborhood<CellType>::getCentroid(const UnsignedIndex_t a_index) const {
        this->checkIndex(a_index);
    ...
    template <class CellType>
    const std::vector<SeparatorVariant> PUSTNeighborhood<CellType>::getSeparators() const {
        return separators_m;
    }
